...
public class CasoTeste2 {
	...
	public CasoTeste2(){
		...
		horario[2][0].setMateria(0, "PIBIC###");
		horario[3][0].setMateria(0, "PIBIC###");
		horario[0][1].setMateria(0, "PIBIC###");
		horario[1][1].setMateria(0, "PIBIC###");
		horario[4][1].setMateria(0, "PIBIC###");
		horario[5][1].setMateria(0, "PIBIC###");
		horario[6][1].setMateria(0, "PIBIC###");
		horario[7][1].setMateria(0, "PIBIC###");
		horario[2][2].setMateria(0, "PIBIC###");
